...
export default function SellerCorrection() {
  return (
    <div className="stitch-page bg-[#f7f5f0] text-on-surface font-body-md text-body-md antialiased min-h-screen flex flex-col selection:bg-primary-container selection:text-white">
      <style>{".material-symbols-outlined {\n      font-family: 'Material Symbols Outlined';\n      font-weight: normal;\n      font-style: normal;\n      font-size: 20px;\n      line-height: 1;\n      letter-spacing: normal;\n      text-transform: none;\n      display: inline-block;\n      white-space: nowrap;\n      word-wrap: normal;\n      direction: ltr;\n      -webkit-font-smoothing: antialiased;\n      vertical-align: middle;\n    }\n    .custom-scrollbar::-webkit-scrollbar {\n      width: 6px;\n      height: 6px;\n    }\n    .custom-scrollbar::-webkit-scrollbar-track {\n      background: #f1ede4;\n    }\n    .custom-scrollbar::-webkit-scrollbar-thumb {\n      background: #d6cfc2;\n      border-radius: 9999px;\n    }\n    .custom-scrollbar::-webkit-scrollbar-thumb:hover {\n      background: #b5ac9b;\n    }"}</style>


<header className="bg-surface-container-lowest border-b border-outline-variant/50 sticky top-0 z-50 shadow-sm">
<div className="w-full h-[68px] flex items-center justify-between px-6 max-w-[1440px] mx-auto">
...
<span className="bg-tertiary-container/15 text-tertiary text-[11px] font-semibold px-2 py-0.5 rounded ml-1 tracking-wider uppercase">KÊNH NGƯỜI BÁN</span>
</Link>

<div className="h-6 w-[1px] bg-outline-variant/60 hidden md:block"></div>

<div className="hidden lg:flex items-center gap-2.5 px-3 py-1.5 rounded-lg bg-surface-container-low border border-outline-variant/40 hover:border-tertiary/60 transition-colors cursor-pointer group">
<span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
<div className="text-left">
<div className="flex items-center gap-1.5 leading-none">
<span className="font-title-md text-[13px] text-on-surface font-medium group-hover:text-tertiary transition-colors">Alpha Books Official</span>
<span className="material-symbols-outlined text-tertiary text-[15px] fill-icon">verified</span>
</div>
<span className="text-[11px] text-on-surface-variant/80">NXB Đối Tác Độc Quyền</span>
</div>
...
<input className="w-full h-9 pl-9 pr-12 text-[13px] bg-surface-container-low border border-outline-variant/60 rounded-lg focus:outline-none focus:border-tertiary focus:ring-1 focus:ring-tertiary placeholder:text-on-surface-variant/60 transition-all" placeholder="Tìm theo SKU, tên sách, đơn duyệt..." type="text" />
<span className="absolute right-2.5 text-[10px] bg-surface-container text-on-surface-variant px-1.5 py-0.5 rounded font-mono border border-outline-variant/40">⌘K</span>
</div>
</div>

<div className="flex items-center gap-4">

<div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-200/80 text-emerald-800 text-[12px] font-medium">
<span className="w-1.5 h-1.5 rounded-full bg-emerald-600"></span>
<span>Gian hàng Đang mở</span>
</div>
<div className="flex items-center gap-1 text-on-surface-variant">
<button className="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-surface-container transition-colors relative" title="Thông báo kiểm duyệt">
<span className="material-symbols-outlined text-[20px]">notifications</span>
<span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-red-500"></span>
</button>
<button className="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-surface-container transition-colors" title="Trợ giúp &amp; Hướng dẫn">
<span className="material-symbols-outlined text-[20px]">help_outline</span>
</button>
</div>

<div className="flex items-center gap-2.5 pl-2 border-l border-outline-variant/50">
<img className="w-8 h-8 rounded-full object-cover ring-1 ring-tertiary/40" alt="Close-up professional headshot portrait of Minh Trí, a young Vietnamese bookstore operations manager wearing modern eyeglasses and a dark linen shirt against a soft library background with warm sunlight." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDJ1WYco6dRiBorwkRaTvRSDEZ02Qd0sKNnx6flj7JrN5_VYOyGoBYR1AUZjsRXA4PJP28JDNPDYar981Fmt3tFe5d_1gF6LTtZH2lJLBpXBCyIr6TXh0BHStTAoqrAh4OINwrX7IYS-KCVApa7IeP5Bl2F_9kiN6bWSWcBV0ej4H0ugNvCXxvidpc-HiP6pncdQ2KUMNkQc6WmBWoNPHgZ6PP5QKb2HrZ3dTtiPMflZ_Gtn-K8BsFFPw" />
<div className="hidden md:block text-left">
<div className="text-[13px] font-semibold text-on-surface leading-tight">Minh Trí</div>
<div className="text-[11px] text-on-surface-variant">Quản trị viên gian hàng</div>
</div>
</div>
</div>
</div>
...
<aside className="w-60 shrink-0 bg-surface-container-lowest border-r border-outline-variant/50 flex flex-col justify-between hidden md:flex py-4">
<div className="space-y-6 px-3">

<div>
<div className="px-3 text-[11px] font-bold text-on-surface-variant/70 tracking-wider uppercase mb-1">TỔNG QUAN</div>
<nav className="space-y-0.5">
<a className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
...
<div>
<div className="px-3 text-[11px] font-bold text-on-surface-variant/70 tracking-wider uppercase mb-1">BÁN HÀNG</div>
<nav className="space-y-0.5">
<a className="flex items-center justify-between px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
<div className="flex items-center gap-2.5">
<span className="material-symbols-outlined text-[19px]">receipt_long</span>
<span>Đơn Hàng</span>
</div>
<span className="bg-surface-container text-on-surface-variant text-[11px] font-semibold px-1.5 py-0.5 rounded-full">12</span>
</Link>

<a className="flex items-center justify-between px-3 py-2 rounded-lg text-[13px] font-semibold bg-emerald-50 text-emerald-800 border border-emerald-200/70 shadow-xs" href="#">
<div className="flex items-center gap-2.5">
<span className="material-symbols-outlined text-[19px] text-emerald-700 fill-icon">book</span>
<span>Sản Phẩm</span>
</div>
<span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" title="Có sản phẩm bị từ chối"></span>
</Link>
<a className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
...
<div>
<div className="px-3 text-[11px] font-bold text-on-surface-variant/70 tracking-wider uppercase mb-1">MARKETING</div>
<nav className="space-y-0.5">
<a className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
...
<div>
<div className="px-3 text-[11px] font-bold text-on-surface-variant/70 tracking-wider uppercase mb-1">CỬA HÀNG</div>
<nav className="space-y-0.5">
<a className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
...
<div>
<div className="px-3 text-[11px] font-bold text-on-surface-variant/70 tracking-wider uppercase mb-1">DỮ LIỆU &amp; TÀI CHÍNH</div>
<nav className="space-y-0.5">
<a className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-[13px] text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface transition-colors" href="#">
...
<div className="pt-4 border-t border-outline-variant/40 px-3 space-y-1">
<a className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[12px] text-on-surface-variant hover:text-on-surface transition-colors" href="#">
...
<a className="flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[12px] text-primary hover:text-primary-container font-medium transition-colors" href="#">
...
<main className="flex-1 flex flex-col min-w-0 bg-[#fbf9f4] pb-24">
...
<a className="hover:text-primary transition-colors" href="#">Kênh Người Bán</Link>
...
<a className="inline-flex items-center gap-1.5 text-[13px] font-medium text-on-surface-variant hover:text-on-surface transition-colors" href="#">
...
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface hover:bg-[#f7f5f0] transition-colors" href="#sec-basic">
<span className="truncate">01 Thông Tin Cơ Bản</span>
<span className="material-symbols-outlined text-emerald-600 text-[16px]">check_circle</span>
</Link>

<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] font-semibold bg-red-50 text-red-800 border border-red-200" href="#sec-description">
...
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface hover:bg-[#f7f5f0] transition-colors" href="#sec-category">
<span className="truncate">03 Phân Loại &amp; Tác Giả</span>
<span className="material-symbols-outlined text-emerald-600 text-[16px]">check_circle</span>
</Link>

<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] font-medium bg-emerald-50/70 text-emerald-800 border border-emerald-200/60" href="#sec-media">
...
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface hover:bg-[#f7f5f0] transition-colors" href="#sec-pricing">
<span className="truncate">05 Giá Bán Kép</span>
<span className="material-symbols-outlined text-emerald-600 text-[16px]">check_circle</span>
</Link>
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface hover:bg-[#f7f5f0] transition-colors" href="#sec-inventory">
<span className="truncate">06 Kho Sách Giấy</span>
<span className="material-symbols-outlined text-emerald-600 text-[16px]">check_circle</span>
</Link>
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface hover:bg-[#f7f5f0] transition-colors" href="#sec-shipping">
<span className="truncate">07 Vận Chuyển</span>
<span className="material-symbols-outlined text-emerald-600 text-[16px]">check_circle</span>
</Link>

<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] font-semibold bg-red-50 text-red-800 border border-red-200" href="#sec-drm">
<span className="truncate">08 Nội Dung Ebook</span>
<span className="material-symbols-outlined text-red-600 text-[16px] animate-bounce">priority_high</span>
</Link>
<a className="flex items-center justify-between px-2.5 py-2 rounded-lg text-[12px] text-on-surface-variant/70 hover:bg-[#f7f5f0] transition-colors" href="#sec-publish">
...
<a className="p-2 rounded-lg bg-red-50 border border-red-200 flex items-start gap-2 hover:bg-red-100/70 transition-colors block" href="#sec-description">
...
<a className="p-2 rounded-lg bg-red-50 border border-red-200 flex items-start gap-2 hover:bg-red-100/70 transition-colors block" href="#sec-drm">
<span className="material-symbols-outlined text-red-600 text-[18px] shrink-0 mt-0.5">cancel</span>
<div className="min-w-0">
<div className="font-semibold text-red-950 flex items-center justify-between">
...
<footer className="w-full mt-space-3xl bg-surface-container-low border-t border-outline-variant/60 py-8">
<div className="max-w-[1280px] mx-auto px-margin-desktop flex flex-col md:flex-row items-center justify-between gap-4 text-on-surface-variant">
<div className="font-headline-sm text-headline-sm font-semibold text-primary">
        HUKI EBOOK SELLER CENTER
      </div>
...
<a className="hover:text-primary transition-colors" href="#">Quy chuẩn kiểm duyệt sách</Link>
