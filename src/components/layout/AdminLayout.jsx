...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F8] text-[#1E293B] flex flex-col font-sans antialiased selection:bg-[#00875A] selection:text-white">
      {/* MAC-STYLE LUXURY SHELL CONTAINER */}
      <div className="w-full max-w-[1720px] mx-auto p-2 sm:p-4 lg:p-6 flex-1 flex flex-col">
          ...
          <header className="h-16 border-b border-[#F1F5F9] px-4 sm:px-6 flex items-center justify-between gap-4 shrink-0 bg-white/95 backdrop-blur-sm sticky top-0 z-30">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/admin/dashboard" className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#003B2B] to-[#00875A] flex items-center justify-center text-white shadow-xs font-black text-sm">
                  H
                </div>
                <div className="flex flex-col">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="bg-[#00875A] text-white text-[9px] font-extrabold uppercase px-1.5 py-0.2 rounded">
                      ROOT
                    </span>
                  </div>
              ...
              {/* Search Bar */}
              <form onSubmit={handleSearch} className="relative hidden md:block w-72 lg:w-96 ml-2">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-[18px]">search</span>
                <input
                  type="text"
                  placeholder="Tìm NXB, ISBN, file DRM, người dùng..."
                  value={searchQuery}
            ...
            <div className="flex items-center gap-2 sm:gap-3.5">
              {/* Date Filter */}
              <div className="hidden xl:flex items-center gap-2 px-3 py-1.5 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] text-xs font-semibold text-gray-700">
              ...
              <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-[#EBF7F2] border border-[#BDE6D7] text-[11px] font-bold text-[#00875A]">
                <span className="w-2 h-2 rounded-full bg-[#00875A] animate-pulse"></span>
                <span>DRM Cluster: Hoạt động</span>
              </div>
              ...
              <div className="flex items-center gap-2.5 pl-2 sm:border-l sm:border-gray-200">
                ...
                <span className="material-symbols-outlined text-[16px] text-gray-400 hidden lg:inline">expand_more</span>
              </div>
            </div>
          </header>

          {/* MAIN WORKSPACE BODY (SIDEBAR + OUTLET) */}
          <div className="flex-1 flex overflow-hidden">
            
            {/* LEFT SIDEBAR NAVIGATION */}
            <aside className={`
              w-64 border-r border-[#F1F5F9] bg-[#FAFBFD] p-3.5 flex flex-col justify-between shrink-0 overflow-y-auto
            ...
            `}>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2.5 min-w-0">
                              <span className={`material-symbols-outlined text-[18px] shrink-0 ${isActive ? 'text-[#00875A]' : 'text-gray-400 group-hover:text-gray-700'} transition-colors`}>
                                {item.icon}
                              </span>
              ...
              {/* Bottom Switcher */}
              <div className="pt-3 mt-3 border-t border-gray-200/80 space-y-1">
                <Link
                  to="/seller/dashboard"
                  className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-gray-600 hover:text-[#003B2B] hover:bg-emerald-50/70 transition-colors"
                >
